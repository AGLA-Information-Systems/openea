...
from utils.test.helpers import add_object_type_permissions_to_security_group, create_organisation, create_security_group, create_user, create_user_profile
...
class RepositoryCreateTestCase(TestCase):
    ...
    def test_repository_create_page_not_authenticated(self):
        ...
        self.assertRedirects(response, '/user/login/?redirect_to=/repository/create/', status_code=302, target_status_code=200, fetch_redirect_response=True)
