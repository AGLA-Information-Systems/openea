...
class ORelationCreateTestCase(TestCase):
    ...
    def test_o_relation_create_page_not_authenticated(self):
        ...
        self.assertRedirects(response, '/user/login/?redirect_to=/o_relation/create/'+ str(bogus_uuid) +'/', status_code=302, target_status_code=200, fetch_redirect_response=True)
    ...
    def test_o_relation_create_page_success(self):
        ...
        response = self.client.get(reverse('o_relation_create', kwargs={'model_id': self.org_1_model_1.id}))
        self.assertRedirects(response, '/user/login/?redirect_to=/o_relation/create/'+ str(self.org_1_model_1.id) +'/', status_code=302, target_status_code=200, fetch_redirect_response=True)
