...
class OrganisationListTestCase(TestCase):
    def setUp(self):
        ...
        self.perm = create_accesspermission(security_group=self.org_1_security_group_1, action='LIST', object_type=self.object_type)
    ...
    def test_organisation_list_page_not_authenticated(self):
        ...
        self.assertRedirects(response, '/user/login/?next=/organisation/list/', status_code=302, target_status_code=200, fetch_redirect_response=True)
